        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                     ...
                     ?>
                    <div class="loginform">
                        <h2 class="text-center lh1">Login Here</h2><br>
                        <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                            <label>Username</label>
                            <input type="text" name="luname" class="form-control" placeholder="Enter User Name" required=""><br>
                             <label>Password</label>
                            <input type="password" name="lpass" class="form-control" placeholder="Enter Password" required=""><br>
                            <input type="submit" name="lsubmit" class="btn btn-success btn-block">
