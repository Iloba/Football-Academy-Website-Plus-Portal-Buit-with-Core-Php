...
<body>
  ...
  <div class="slider">
      ...
      <div class="logosection" data-aos="fade-up" data-aos-duration="2000"> 
            <div class="container">
                <div class="row">
        ...
        <div class="sectionOne" data-aos="fade-up" data-aos-duration="2000">
        ...
        <div>
             <div class="sectionTwo" data-aos="fade-up" data-aos-duration="2000" >
                    <div class="container">
                        <div class="row"><br>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="about.php" class="btn btn-block btext  btn-info"><img class="trophy img-fluid" src="img/trophy.svg" alt=" P & A Football Academy"> WHY P & A Academy</a>
                    </div>
                    <div class="col-md-2">
                        &nbsp;
                    </div>
                    <div class="col-md-4">
                        <a href="team.php" class="btn btn-block btext btn-info"><img class="trophy" src="img/trophy.svg" alt=" P & A Football Academy">Visit FOOTBALL ACADEMY</a>
                    </div>
                    <div class="col-md-1">
                        &nbsp;
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-footer">   
                                <a class="btn btn-info btn-block" href="contact.php">Join Now</a>
                            </div>
                        </div>
                    </div> <br>
                    <div class="col-md-4">
        ...
        <div class="sectiondiv">
            <div class="container">
                <div class="col-md-12"> <br>
                    <p class="ttt"> We are Fully Registered with the FA and Affiliated with the Nigerian Football Federation.
                        We Recruit and Market Players of Different Categories of U15, U17 U20 and Above  <br> <a class="btn btn-info" href="about.php">See More</a></p>
                </div>
            </div>
        </div>

        <div class="video" data-aos="fade-up" data-aos-duration="2000">
            <h2 id="h1" class="text-center welcome ">Watch Our Videos Below</h2> <br>
            <div class="container">
                <div class="row">
                    <div class="col-md-2">
                    &nbsp;
                    ...
                    <div class="col-md-4">  
                        <div class="card">   
                            <div class="card-body">   
                                ...
                                <div class="card-footer">
                                    <h3 style="color: #fff;" class="text-center cn">Mr Pato</h3>
                                     <h5 style="color: #fff;" class="text-center ct"><i> President</i></h5>
                        ...
                        <div class="card">   
                            <div class="card-body">   
                                ...
                                <p class="text-center ctt"> 
                                    It's Simple to Understand P&A Football Academy, Kaduna Nigeria. It is a place for talents discovery, nurturing and exposure to the highest level of footballing possible. At P&A, we ensure the fulfilment of your God given destiny through Systematic, structured and dynamic programs designed to suit and develop an individual talent.
                                    That's why our dynamic and goals acheiving founder/Chairman stands as an all round support. Keep faith. As you desire it. we will help you actualize it. P&A, where dreams, desires become realities.
                                </p>
                               <div class="card-footer">
                                     <h3 style="color: #fff;" class="text-center cn">Mr Sidney Terna Mato</h3>
                                    <h5 style="color: #fff;" class="text-center ct"><i>Coordinator</i></h5>
                               </div>
                    ...
                    <div class="col-md-4">  
                        <div class="card">   
                            <div class="card-body">   
                                ...
                                <br> <br>      
                                <p class="text-center ctt">P & A Football Academy, raises stars and Football Legends of tomorrow. Our Motivation and
                                    Training Sessions have really developed and Shaped many Football Players into what they are today.
                                </p>
                               <div style="color: #fff;" class="card-footer">
                                    <h3 style="color: #fff;" class="text-center cn">Coach Auta Philip Anthony </h3>
                                <h5 style="color: #fff;" class="text-center ct"><i>Head Coach</i></h5>
                               </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mapsection" data-aos="fade-up" data-aos-duration="2000">
                        <h2 class="text-center welcome">Locate Us today</h2>
            ...
            <div class="row">
             ...
             <div class="row">
                ...
                <div class="col-md-3">
                    <div class="card">
                        <div class="card-body">
                             <div style="height: 250px; background: transparent no-repeat center; background-size:cover; background-image: url('img/gal7.jpg')">
                                 &nbsp;
                            </div>
                            <div class=" card-footer">
        ...
        <div class="inv" data-aos="fade-up" data-aos-duration="2000">
            <div class="container"><br>
                <h2 id="h1" class="text-center  welcome">Our Investments</h2><br>
                <div class="row">
