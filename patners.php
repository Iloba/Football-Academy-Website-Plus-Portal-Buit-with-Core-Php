                ...
                <div class="col-md-10"><br>
                   <div class="card">
                       ...
                       <div class="card-header">
                           <h1 class="text-center">Patners</h1>
                       </div>
                       <div class="card-body">
                               ...
                               <table class="table table-bordered">
                                   <?php 
                                        ...
                                        if (isset($_POST['delete_btn'])) {
                                            ...
                                            $query = "DELETE FROM patners WHERE id = '$delete_id'";
                                       ...
                                       <?php if (isset($err)) {
                                        ...
                                        if (isset($good)) {
                                         ...
                                         ?>
                                    <?php
                                        while ($pat = mysqli_fetch_assoc($run_query)) :
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td><?php echo $pat['Address']; ?></td>
                                              <td><?php echo $pat['Msg']; ?></td>
                                            <td>
                                                <form method="POST">
                                                    <input type="hidden" name="delete_id" value="<?php echo $pat['id']; ?>">
