                  ...
                  <?php if (isset($err)) {
                   ...
                   <div class="card">
                       ...
                       <div class="card-header">
                           <h1 class="text-center">Upload Player for Transfer</h1>
                       </div>
                       <div class="card-body">
                            <div class="form_players">
                              <h1 class="text-center lh1"></h1>
                                <form method="POST" action="" enctype="multipart/form-data">
                                   <input type="hidden" name="size" value="10000000">
                                  <label><b>Choose File (Images Only)</b></label>
                                   <input type="file" name="ppas" class="form-control" placeholder="Enter Player Name" required><br>
                                    ...
                                    <input type="text" name="ppos" class="form-control" placeholder="Enter Player Pos" required><br>
                                    <input type="text" name="pbfoot" class="form-control" placeholder="Enter Player Best Foot" required><br>
                                    <input type="submit" name="tsubmit" class="btn btn-success btn-block" value="Upload Player" >
