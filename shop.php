            ...
            <div class="row">
               <div class="col-md-2">
                ...
                <div class="col-md-8 ">
                    <div class="place">
                        <div class="placebox">
                            <p class="text-center">To Place a Request on our Jerseys, Kindly Click the Buy Now Button..you will be Redirected to a Contact Form, Kindly Fill the Form..Tell Us about your Interest and Specifications and we will get back to you</p>
                        </div>
                    </div><br>
                    <div class="card">
                        <div class="card-header">
                            <h2 class="text-center sales teama">We are Specialized in the Sales of Jerseys, Training Kit and Accessories</h2><br>
                        </div>
                        <div class="card-body">
                            
                             <img class="img-fluid bigj mx-auto d-block" src="img/j1.jpg">
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="card card-header">
                        <img class="img-fluid playerpic" src="img/j2.jpg">
                    </div>
                    <div class="card card-body">
                       <div class="pdet">
                            <div class="">
                                <h3 class=" name">Jersey Kit</h3>
                                <p class="down">
                                     <b class="mar">Price: <span class="price">Available on Order</span></b><br>
                                <a class="btn btn-success btn-block" href="contact.php">Buy Now</a>
                                </p>
                            </div>
                       </div>
                    </div>
                ...
                <div class="col-md-3">
                    <div class="card card-header">
                        <img class="img-fluid playerpic" src="img/j3.jpg">
                    </div>
                    <div class="card card-body">
                      <div class="pdet">
                            <div class="">
                ...
                <div class="col-md-3">
                    <div class="card card-header">
                       <img class="img-fluid playerpic" src="img/j4.jpg">
                    </div>
                    <div class="card card-body">
                       <div class="pdet">
                            <div class="">
                ...
                <div class="col-md-3">
                    <div class="card card-header">
                       <img class="img-fluid playerpic" src="img/j5.jpg">
                    </div>
                    <div class="card card-body">
                       <div class="pdet">
                            <div class="">
