...
<head>
   <link rel="icon" href="img/logo.png">
	<title> About P & A Football Academy</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="aboutHead" data-aos="fade-up" data-aos-duration="2000">
        <div class="container">
            <div class="row"><br>
                <div class="col-md-1">
                    &nbsp;
    ...
    <div class="aboutTwo" data-aos="fade-up" data-aos-duration="2000">
        <div class="container">
            <div class="row"><br>
                <div class="col-md-1">
                    &nbsp;
